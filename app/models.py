...
class Product(db.Model):
    ...
    order_items_rel = db.relationship('OrderItem', backref='associated_product', overlaps="order_items")
...
class Cart(db.Model):
    ...
    user = db.relationship('User', backref='carts_owned')  # Renamed back reference
